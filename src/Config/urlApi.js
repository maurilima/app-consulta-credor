// export const BASE_URL  = 'http://coger-services.rr.gov.br:9000/transparencia/'          //  desenv
export const BASE_URL  = 'https://transparencia.rr.gov.br/transparencia-api/' // Produção
